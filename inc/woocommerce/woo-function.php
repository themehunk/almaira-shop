...
/** wishlist **/
/**********************/
function almaira_shop_whish_list($pid = ''){
...
add_action( 'woocommerce_before_add_to_cart_quantity', 'almaira_display_quantity_minus',10,2 );
function almaira_display_quantity_minus(){
    echo '<div class="almaira-quantity"><button type="button" class="minus" >-</button>';
}
add_action( 'woocommerce_after_add_to_cart_quantity', 'almaira_display_quantity_plus',10,2 );
function almaira_display_quantity_plus(){
